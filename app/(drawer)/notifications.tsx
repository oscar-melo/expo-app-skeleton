...
export default function NotificationsScreen() {
    ...
    return (
        <View style={styles.container}>
            <Stack.Screen options={{ title: 'Registros de Notificaciones' }} />
            {notifications.length === 0 && !loading ? (
                <View style={styles.centered}>
                    <AppText variant="subtitle">No hay registros</AppText>
                    <AppText variant="caption">Escuchando nuevas notificaciones...</AppText>
                </View>
            ) : (
                <FlatList
                    data={notifications}
...
const styles = StyleSheet.create({
    ...
    recordCard: {
        ...
        // Sombra sutil para mejor estética
        shadowColor: '#000',
